...
| 2 | Создание сценария тестирования для vector-role 
| 3 | Добавление дистрибутивов (ubuntu:22.04) |
| 4 | Написание verify.yml с проверками |
| 5 | Настройка idempotence тестов |
| 6 | Создание тегов v1.0.0, v1.1.0, v1.2.0 |
| 7 | Настройка Tox |
| 8 | Создание тестов для lighthouse-role |
| 9 | Создание full-stack-role (интеграция) |
